...
public abstract class BaseEntity {
    @Column(name="create_at") private LocalDateTime createAt;
    @Column(name="update_at") private LocalDateTime updateAt;
    ...
    @Column(name="delete_by") private String deleteBy;

    @PrePersist protected void onCreate() {
        if (createAt == null) createAt = LocalDateTime.now();
        if (isDeleted == null) isDeleted = false;
    }
    @PreUpdate  protected void onUpdate() { updateAt = LocalDateTime.now(); }
}
